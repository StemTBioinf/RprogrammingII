...
We need to have a slot made in the S4 calss up front before we try to populate it. In this case we know that 
...
```
When you have done that set the working directory to the folder that was just created. 
...
Its always a good idea to make many R scripts with less in them, than having one R script with everything in it. 
In this script the only thing we want to do is define the class. It looks a little like this:
